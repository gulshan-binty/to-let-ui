...
@Component({
  selector: 'app-product-list-job',
  templateUrl: './product-list-job.component.html',
  styleUrls: ['./product-list-job.component.scss']
})

export class ProductListJobComponent implements OnInit, OnDestroy {
  ...
  private getAllProducts(loadMore?: boolean) {
    ...
    const filterData: FilterData = {
      ...
      filter: { ...mFilter, status: 'publish',postType: "job_post" },
