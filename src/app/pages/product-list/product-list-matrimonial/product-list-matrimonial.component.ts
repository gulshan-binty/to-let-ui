...
@Component({
  selector: 'app-product-list-matrimonial',
  templateUrl: './product-list-matrimonial.component.html',
  styleUrls: ['./product-list-matrimonial.component.scss']
})

export class ProductListMatrimonialComponent implements OnInit, OnDestroy {
  ...
  private getAllProducts(loadMore?: boolean) {
    ...
    const filterData: FilterData = {
      ...
      filter: { ...mFilter, status: 'publish',postType: 'matrimonial' },
